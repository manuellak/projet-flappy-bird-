...
class ScoreManager {
    constructor() {
        ...
        this.points = 0
        ///
        let beststr=localStorage.getItem(save_score)
        if (beststr== null){
            this.best=0
        }else{
            this.best= parseInt(beststr)
        }
        ///
        this.lives = 3
    ...
    incrementsPoints(amt) {
        ...
        if(this.points>this.best){
            ...
            localStorage.setItem(save_score,this.best)
        }
        gSounds["score"].setVolume(0.2)
        gSounds["score"].play()
    ...
    render() {
        ...
        this.label.setText("Best: " + this.best)
        this.label.render(350, 30)
